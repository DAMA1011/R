...
degree <- factor(degree, order=TRUE, levels=c("Bachelor","master","doctor"))
degree
str(degree)
levels(degree)
...
#  Mary   3000   26
#  John   4000   31
value <- c(3000, 4000, 26, 31)
rname <- c("Mary", "John")
cname <- c("salary", "age")
g <- matrix(value, nrow=2, ncol=2, byrow=F, dimnames=list(rname, cname))
g
...
score <- c(80.0, 36.0, 88.9, 97.5, 60.0)
data <- data.frame(student_ID, name, score)
data
...
# $ages
# [1] 25 26 18 39 50
mylist <- list(title="My First List", names=c("John", "Mary", "Sam", "Peter", "Susan"), ages=c(25, 26, 18, 39, 50))
mylist
